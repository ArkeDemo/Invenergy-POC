...
export const Overview1 = (props: any) => {
  ...
  return (
    <>
      <section data-testid='overview section' style={{backgroundImage: `url("${image.image.url}")`, backgroundRepeat: 'no-repeat'}}>
        <div className="p-template-4__overview" style={{height: '70rem'}}>
